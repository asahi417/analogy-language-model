...
methods = ['ppl', 'ppl_tail_masked', 'ppl_head_masked', 'embedding_similarity', 'ppl_pmi', 'ppl_add_masked', 'pmi']
            ...
            for _temp in all_templates:
                ...
                if scoring_method == 'ppl_pmi':
                    for v in ppl_pmi_marginal_version:
                        scorer.analogy_test(
                            ppl_pmi_marginal_version=v, ppl_pmi_aggregation=ppl_pmi_aggregation, **shared)
